...
public class StudentView extends JFrame implements ActionListener, ListSelectionListener {
    ...
    private JButton addStudentBtn, editStudentBtn, deleteStudentBtn, clearBtn, sortStudentGPABtn, sortStudentNameBtn;

    private JScrollPane jScrollPaneStudentTable, jScrollPaneAddress;

    private JTable studentTable;

    private JLabel idLabel, nameLabel, ageLabel, addressLabel, gpaLabel;
    ...
    private String[] columnNames = new String[] { "ID", "Name", "Age", "Address", "GPA" };
